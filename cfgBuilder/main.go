// Copyright 2020 cypherium Systems
// SPDX-License-Identifier: LGPL-3.0-only
/*
Builds the configuration files for the meshbridge application.
*/
package main
...
func init() {
	app.Action = run
	app.Copyright = "Copyright 2019 cypherium Systems Authors"
	app.Name = "cfgBuilder"
	app.Usage = "cfgBuilder [source] [destination]"
	app.Authors = []*cli.Author{{
		Name: "cypherium Systems 2019",
	}}
